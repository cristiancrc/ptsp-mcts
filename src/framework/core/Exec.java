...
public class Exec
{
    ...
    /**
     * Time to wait, where visuals are on, before starting the game.
     */
    public static int m_warmUpTime = 750;
    ...
    protected static boolean initializeController(Constructor a_cons, String a_contName)
    {
        ...
        long finalDateMs = startingTime + PTSPConstants.getStepsInit(m_game.getNumWaypoints());
        boolean ok = false;
    ...
    protected static boolean runFromData( char[][] map, Vector2d startingPoint, LinkedList<Vector2d> wayPoints, LinkedList<Vector2d> fuelTanks)
    {
        //Create the game instance.
